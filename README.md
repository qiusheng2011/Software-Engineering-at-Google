...
|                   |               | chapter 22 : Large-Scale Changes                   | [第二十二章：大规模变更](./zh-cn/Chapter-22_Large-Scale_Changes/Chapter-22_Large-Scale_Changes.md) | 完成校验 | @qiangmzsx                               | 2022-03-10     | 宠物类比的是传统服务器或虚拟机，每一个都被照顾得很好，不可或缺，不会自动变得有序。家畜比的是云端服务器实例，量多、可替代、短生命周期，可以自动变得有序。 |
